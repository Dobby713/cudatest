...
class define_VGG_P(nn.Module):
    def __init__(self):
        super(define_VGG_P, self).__init__()
        vgg = models.vgg16(True)
        self.vgg_f = vgg.features
        self.vgg_p1 = self.add_module(0, 4, 'p1')
        self.vgg_p2 = self.add_module(5, 9, 'p2')
        self.vgg_p3 = self.add_module(10, 16, 'p3')
        self.vgg_p4 = self.add_module(17, 23, 'p4')
        self.vgg_p5 = self.add_module(24, 30, 'p5')

    def add_module(self, st_idx, ed_idx, name):
        target_module = nn.Sequential()
